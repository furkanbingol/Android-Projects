package com.furkanbingol.catchthesid;
...
public class MainActivity extends AppCompatActivity {
    TextView textView;   //time text
    TextView textView2;  //score text
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CountDownTimer(15000,1000)  //Total 15 sn! 1 sn aralıklarla çalış
        {
            @Override
            ...
            public void onFinish() {
                ...
                for(ImageView image : imageArray){    //Süre bittiği için tüm resimleri tekrar hide'ladık.
